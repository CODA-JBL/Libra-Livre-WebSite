...
// }
        ...
        $(this).children(".fav").html('<a class="fiche_link" href="./fiche.php">'+ data.books[theBook].title + '</a>' + '</br><a class="fav_link" href="userpage.php"><img class="add_img" src="./star-add.png"></a>');
